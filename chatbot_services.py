...
def process_document(file_path: str, user_id: int, document_id: int, file_name: str):
    """
    Loads a document from a file path, splits it into chunks, generates embeddings,
    and stores them in a user-specific collection in ChromaDB.
    """
    ...
    try:
        # Load the document using UnstructuredFileLoader for broad file type support
